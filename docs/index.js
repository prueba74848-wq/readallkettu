...
// ---- plugin export -------------------------------------------------------
// CommonJS, not ES `export` — confirmed via /eval that the loader executes
// plugin code as a plain script (SyntaxError: 'export' statement requires
// module mode), the same way StealSticker's bundled output is wrapped.
